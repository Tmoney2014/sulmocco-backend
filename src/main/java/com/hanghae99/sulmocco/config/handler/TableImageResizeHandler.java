package com.hanghae99.sulmocco.config.handler;
...
public class TableImageResizeHandler implements RequestHandler<S3Event, String> {

    private static final float MAX_WIDTH = 400;
    private static final float MAX_HEIGHT = 260;
    ...
    public String handleRequest(S3Event s3event, Context context) {
        try {
            ...
            try {
                ...
                s3Client.putObject(new PutObjectRequest(dstBucket, dstKey, is, meta).withCannedAcl(
