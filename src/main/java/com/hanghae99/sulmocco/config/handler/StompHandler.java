...
//            String loginId = jwtDecoder.decodeLoginId(accessor.getFirstNativeHeader("Authorization").substring(7));
...
//                if (redisRepository.getUserCount(chatRoomId) < 0) { //입장유저가 -보다 작을때 0으로 셋팅
