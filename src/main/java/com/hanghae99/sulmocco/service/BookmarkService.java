...
public class BookmarkService {
    ...
    public ResponseEntity<?> getbookmark(UserDetailsImpl userDetails) {
        ...
        for(Bookmark bookmark : bookmarks) {
            bookmarkResponseDtoList.add(new BookmarkResponseDto(bookmark.getTables().getTitle(),bookmark.getTables().getUser().getUsername(),bookmark.getTables().getContent(),bookmark.getTables().getId()));
        }
